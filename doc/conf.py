...
latex_documents = [
  (master_doc, 'refnx.tex', 'refnx Documentation',
   'Andrew Nelson', 'manual'),
]
...
man_pages = [
    (master_doc, 'refnx', 'refnx Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'refnx', 'refnx Documentation',
   author, 'refnx', 'One line description of project.',
   'Miscellaneous'),
]
