...
/*-----------------------------------------------
              @(target):= __creflect.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit___creflect

#else
#  define SWIG_init    init__creflect

#endif
#define SWIG_name    "__creflect"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_abeles(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOO:abeles",&obj0,&obj1,&obj2)) SWIG_fail;
  {
    npy_intp dims[1];
    if (!PyInt_Check(obj0))
    {
  ...
  abeles(arg1,arg2,arg3,arg4,arg5,arg6);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"abeles", _wrap_abeles, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
